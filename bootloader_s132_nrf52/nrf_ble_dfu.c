...
#define DEVICE_NAME                          "ACT-DFU2"                                              /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                    "Matilde Inc."                                  /**< Manufacturer. Will be passed to Device Information Service. */
